 ...
 */
public class SearchResultGroupAdapter extends ArrayAdapter<Group> {
    public SearchResultGroupAdapter(Context context, int resource, ArrayList<Group> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.groupMemberNumber = (TextView)
                    convertView.findViewById(R.id.group_member_number);
        ...
        viewHolder.groupMemberNumber.setText(
                getContext().getResources().getQuantityString(R.plurals.group_number,
                        item.getNumberOfUsers(), item.getNumberOfUsers()));
